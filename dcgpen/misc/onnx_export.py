...
from dcgpen.face_model.gpen_model import FullGenerator
...
def verify_onnx(model, path, force_cpu):
    ...
    print(
        "Example: Onnx model has been tested with ONNXRuntime, the result looks good !"
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--force-cpu", dest="force_cpu", help="Verify onnx model", action="store_true"
    )

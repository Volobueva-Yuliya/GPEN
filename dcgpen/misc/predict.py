...
class Predictor(cog.Predictor):
    def setup(self):
        ...
        self.faceenhancer = FaceEnhancement(
            size=faceenhancer_model["size"],
            model=faceenhancer_model["name"],
        ...
        self.faceinpainter = FaceInpainting(
            size=faceinpainter_model["size"],
            model=faceinpainter_model["name"],
            channel_multiplier=2,
        )
        facecolorizer_model = {"name": "GPEN-Colorization-1024", "size": 1024}
        self.facecolorizer = FaceColorization(
            size=facecolorizer_model["size"],
            model=facecolorizer_model["name"],
            channel_multiplier=2,
        )
    ...
    def predict(
        self, image, task="Face Restoration", output_individual=False, broken_image=True
    ):

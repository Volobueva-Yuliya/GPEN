...
class FaceParse:
    def __init__(self, base_dir='./',
        ...
        # self.#MASK_COLORMAP = [[0, 0, 0], [204, 0, 0], [76, 153, 0],
        # [204, 204, 0], [51, 51, 255], [204, 0, 204], [0, 255, 255],
        # [255, 204, 204], [102, 51, 0], [255, 0, 0], [102, 204, 0],
        # [255, 255, 0], [0, 0, 153], [0, 0, 204], [255, 51, 153], [0,
        # 204, 204], [0, 51, 0], [255, 153, 51], [0, 204, 0]] = [[0,
        # 0, 0], [204, 0, 0], [76, 153, 0], [204, 204, 0], [51, 51,
        # 255], [204, 0, 204], [0, 255, 255], [255, 204, 204], [102,
        # 51, 0], [255, 0, 0], [102, 204, 0], [255, 255, 0], [0, 0,
        # 153], [0, 0, 204], [255, 51, 153], [0, 204, 204], [0, 51,
        # 0], [0, 0, 0], [0, 0, 0]]
        self.MASK_COLORMAP = [
            0,
            255,
    ...
    def load_model(self):
        self.faceparse = ParseNet(
            ...
            ch_range=[
                32,
                256])
        self.faceparse.load_state_dict(
            torch.load(
                self.mfile,
    ...
    def process_tensor(self, imt):
        imt = F.interpolate(
            imt.flip(1) * 2 - 1, (self.size, self.size))
        pred_mask, sr_img_tensor = self.faceparse(imt)

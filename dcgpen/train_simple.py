...
from dcgpen.distributed import (
    get_rank,
    get_world_size,
    reduce_loss_dict,
    reduce_sum,
...
from dcgpen.face_model.gpen_model import Discriminator, FullGenerator
from dcgpen.training import lpips
from dcgpen.training.data_loader.dataset_face import FaceDataset
from dcgpen.training.loss.id_loss import IDLoss
...
def g_nonsaturating_loss(
    fake_pred, loss_funcs=None, fake_img=None, real_img=None, input_img=None
):
